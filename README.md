...
```shell
export CONTAINER_NAME=modelscope_env_py38
export IMAGE_NAME=registry.cn-hangzhou.aliyuncs.com/modelscope-repo/modelscope:ubuntu20.04-cuda11.7.1-py38-torch2.0.1-tf1.15.5-1.8.1

docker run --name ${CONTAINER_NAME} \
-v /data1/xxx/xx:/host/data \  # dir mapping host -> container
--shm-size=160G \
--net=host \
--gpus all \
--entrypoint /bin/bash \
...
# clone repo
git clone https://github.com/jyhe89/MetaDesigner.git
cd MetaDesigner && pip install -r requirements.txt
# 
python test_wordart_v1.py
```
